...
#
# Usage: docker build -f ./2024.3_openmpi_generic_cuda_P100_psmp.Dockerfile -t cp2k/cp2k:2024.3_openmpi_generic_cuda_P100_psmp .
...
# Download CP2K
RUN git clone --recursive -b support/v2024.3 https://github.com/cp2k/cp2k.git /opt/cp2k
